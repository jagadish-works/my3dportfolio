...
const About = () => {
  return (
    <>
      ...
      >
        Hi, I’m Jagadish Mattimalla— a passionate Frontend / Full Stack Developer
        with hands-on experience in building modern, responsive web applications
        using technologies like HTML, CSS, JavaScript,React.js and Node.js.
        I’ve worked on real-world freelance projects, where I pushed my creativity and technical
